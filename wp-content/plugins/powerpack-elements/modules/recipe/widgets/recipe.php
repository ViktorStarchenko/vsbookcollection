		...
		<div class="pp-recipe-container" itemscope="" itemtype="http://schema.org/Recipe">
			...
			<div class="pp-recipe-details pp-recipe-section">
				<ul class="pp-recipe-detail-list">
					...
					<li itemprop="prepTime" content="PT<?php echo $settings['prep_time']; ?>M">
						...
						<span class="pp-recipe-detail-content">
							...
							<span class="pp-recipe-detail-value">
								<?php echo $settings['prep_time'] . ' ' . $settings['prep_time_unit']; ?>
							</span>
						</span>
					</li>
					<?php } ?>
					<?php if ( $settings['cook_time'] ) { ?>
					<li itemprop="cookTime" content="PT3<?php echo $settings['cook_time']; ?>M">
						...
						<span class="pp-recipe-detail-content">
							...
							<span class="pp-recipe-detail-value">
								<?php echo $settings['cook_time'] . ' ' . $settings['cook_time_unit']; ?>
							</span>
						</span>
					</li>
					<?php } ?>
					<?php if ( $settings['total_time'] ) { ?>
					<li itemprop="totalTime" content="PT<?php echo $settings['total_time']; ?>M">
						...
						<span class="pp-recipe-detail-content">
							...
							<span class="pp-recipe-detail-value">
								<?php echo $settings['total_time'] . ' ' . $settings['total_time_unit']; ?>
							</span>
						</span>
					</li>
					<?php } ?>
					...
					<li itemprop="recipeYield">
						...
						<span class="pp-recipe-detail-content">
							...
							<span class="pp-recipe-detail-value">
								<?php echo $settings['servings'] . ' ' . $settings['servings_unit']; ?>
							</span>
						</span>
					</li>
					<?php } ?>
					...
					<li itemprop="nutrition" itemscope="" itemtype="http://schema.org/NutritionInformation">
						<span itemprop="calories">
							...
							<span class="pp-recipe-detail-content">
								...
								<span class="pp-recipe-detail-value">
									<?php echo $settings['calories'] . ' ' . $settings['calories_unit']; ?>
								</span>
							</span>
						</span>
					</li>
			...
			<div class="pp-recipe-ingredients pp-recipe-section">
				<h3 class="pp-recipe-section-heading pp-recipe-ingredients-heading">
					<?php echo ( $settings['ingredients_title'] ) ? $settings['ingredients_title'] : esc_attr__( 'Ingredients', 'powerpack' ); ?>
				</h3>
			...
			<div class="pp-recipe-instructions pp-recipe-section">
				<h3 class="pp-recipe-section-heading pp-recipe-instructions-heading">
					<?php echo ( $settings['instructions_title'] ) ? $settings['instructions_title'] : esc_attr__( 'Instructions', 'powerpack' ); ?>
				</h3>
			...
			<?php if ( $settings['item_notes'] ) { ?>
				<div class="pp-recipe-notes pp-recipe-section">
					<h3 class="pp-recipe-section-heading pp-recipe-notes-heading">
						<?php echo ( $settings['notes_title'] ) ? $settings['notes_title'] : esc_attr__( 'Notes', 'powerpack' ); ?>
					</h3>
