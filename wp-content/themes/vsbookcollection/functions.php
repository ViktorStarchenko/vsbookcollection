...
//        main custom styles
    wp_enqueue_style( 'custom-styles', get_theme_file_uri( '/assets/css/custom-styles.css' ), array('swiper'));

//        jquery
    wp_enqueue_script( 'jq', get_theme_file_uri( '/assets/js/jquery-3.2.1.min.js' ), array(), '1', true );
//        bootstrap scripts
//    wp_enqueue_script( 'bootstrap', get_theme_file_uri( '/assets/js/bootstrap.min.js' ), array(), '1', true );
//        fontawesome
    wp_enqueue_script( 'fontawesome', get_theme_file_uri( '/assets/js/all.js' ), array(), '1', true );
////        swiper slider scripts
    wp_enqueue_script( 'swiperjs', get_theme_file_uri( '/assets/js/swiper-bundle.min.js' ), array(), '1', true );
//        instafeel.js
//    wp_enqueue_script( 'instafeed-js', get_theme_file_uri( '/assets/js/instafeed.min.js' ), array(), '1', true );
//        main custom scripts
    wp_enqueue_script( 'main', get_theme_file_uri( '/assets/js/main.js' ), array(), '1', true );

//        wp_enqueue_script( 'test', get_theme_file_uri( '/assets/js/test.js' ), array(), '1', true );

    wp_localize_script('main', 'generalData', array(
...
include 'includes/custom-gutenberg-blocks.php';