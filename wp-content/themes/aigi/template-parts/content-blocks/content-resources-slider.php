                    ...
                    <div>
                        <div class="rslider__item rslider__resource-item  <?php echo $post_type; ?>">
                            ...
                            <div class="rslider__item-body">
                                <a class="rslider__title" href="<?=  get_the_permalink($post->ID) ?>" data-height="ResourcesrsliderTitle"><?= $post->post_title; ?></a>
                                ...
                                <div class="rslider__excerpt" data-height="ResourcesrsliderDesc"><?php echo get_custom_excerpt($excerpt, 94, true) ?></div>

                                <div class="rslider__tags" data-height="ResourcesrsliderTags">
