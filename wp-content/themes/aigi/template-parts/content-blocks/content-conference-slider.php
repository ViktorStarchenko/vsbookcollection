        ...
        $posts = get_posts( array(
            ...
            'tax_query' => array(
                array(
                    ...
                    'field'    => 'slug',
                    'terms'    => 'indigenous-governance-award'
                )
            )
        ) );
...
//                                        echo '<br>';
                                ...
                                <div class="rslider__item-body">
                                    <a class="rslider__title" href="<?=  get_the_permalink($post->ID) ?>" data-height="ConferencersliderTitle"><?= $post->post_title; ?></a>
                                    ...
                                    <div class="rslider__excerpt" data-height="ConferencersliderDesc"><?php echo get_custom_excerpt($excerpt, 94, true) ?></div>

                                    <div class="rslider__tags" data-height="ConferencersliderTags">
