            ...
            <div class="rslider__wrapper">
                <div class="slider rslider rslider-<?php echo $attributes['uniq_id'];?> rslider__speakers">
                    <?php foreach( $posts as $post ) :
                        ...
                        <?php $terms =  wp_get_post_terms( $post->ID, 'genre', array('fields' => 'names') );
                        ?>
                        <div>
                                ...
                                <div class="rslider__item-body">
                                    <div class="speakers__bio"  data-height="SpeakersrsliderTitle">
                                        ...
                                        <div class="speakers__bio-text">
                                            ...
                                            <?php $wrirer =  wp_get_post_terms( $post->ID, 'wrirer', array('fields' => 'names') );
                                            ?>
                                            <?php if ($wrirer) { ?>
                                                <div class="speakers__position"><?php echo $wrirer[0]; ?></div>
                                            <?php } ?>
                                    ...
                                    $excerpt = '';
                                    ?>
                                    <div class="rslider__excerpt" data-height="SpeakersrsliderDesc"><?php echo get_custom_excerpt($post->post_content, 234, true) ?></div>
...
<script>
    ...
    jQuery('.rslider-<?php echo $attributes['uniq_id'];?>').slick({
        // variableWidth: true,
        slidesToShow: 3,
        slidesToScroll: 1,
