...
<main id="content" role="main">
    <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
                    ...
                    <div class="col-sidebar"  data-height="pageSidebarCol">
                        <div class="col-sidebar__inner">
                            ...
                            <div class="post-details">
                                ...
                                <div class="post-details__item">
                                    ...
                                    <div class="post-details__text">
                                        <div class="location_item">
                                            <div class="post-details__icon">
                                                <img src="/wp-content/themes/aigi/assets/images/pin.svg" title="location" />
                                            </div>
                                            <a class="post-details__link" href="https://maps.google.com/?q=<?php echo $location['lat'];?>,<?php echo $location['lng'];?>" target="_blank"><?= $location['address']; ?></a>
                                        </div>
                                    </div>
                                <?php endforeach ?>
                                </div>
                                ...
                                <?php if (get_field('contacts')['phone']) : ?>
                                <div class="post-details__item">
                                    <div class="post-details__heading">Phone</div>
                                    <?php foreach (get_field('contacts')['phone'] as $phone) : ?>
                                    <div class="post-details__text">
                                        <div class="location_item">
                                            <div class="post-details__icon">
                                                <img src="/wp-content/themes/aigi/assets/images/phone.svg" title="phone" />
                                            </div>
                                            <span class="phone-type"><?php echo $phone['type']; ?></span>
                                            <a class="post-details__link" href="tel:<?php echo $phone['number']; ?>"><?php echo $phone['number']; ?></a>
                                        </div>
                                    </div>
                                <?php endforeach ?>
                                </div>
                                ...
                                <div class="post-details__item">
                                    <div class="post-details__heading">Email</div>
                                    <?php foreach (get_field('contacts')['email'] as $email) : ?>
                                    <div class="post-details__text">
                                        <div class="location_item">
                                            <div class="post-details__icon">
                                                <img src="/wp-content/themes/aigi/assets/images/email.svg" title="email"/>
                                            </div>
                                            <a class="post-details__link" href="mailto:<?php echo $email['item']; ?>"><?php echo $email['item']; ?></a>
                                        </div>
                                    </div>
                                <?php endforeach ?>
                                </div>
        ...
        <?php if(get_field('contacts')['enable_map']) : ?>
